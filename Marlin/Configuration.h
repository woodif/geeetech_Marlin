...
#define STRING_CONFIG_H_AUTHOR "(wd, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "EasyKids"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 40, 1000 }
